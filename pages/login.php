...
<div class="tb-auth-center">
  ...
  <div class="tb-auth-card tb-fade-in">
    ...
    <div class="grid grid-cols-3 gap-2 mb-5">
      <button onclick="ql('ana_delacruz@gmail.com')"       class="btn btn-ghost btn-sm">Buyer</button>
      <button onclick="ql('seller_leila@gmail.com')"       class="btn btn-ghost btn-sm">Seller</button>
      <button onclick="ql('admin@gmail.com')"             class="btn btn-ghost btn-sm">Admin</button>
    </div>
